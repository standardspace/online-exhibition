...
if (maGallery) {
  // Grid the gallery
  var maGalleryGrid = macy__WEBPACK_IMPORTED_MODULE_0___default()({
    container: maGallery,
    trueOrder: true,
    waitForImages: false,
    mobileFirst: true,
  ...
  var galleryItemsArray = _toConsumableArray(galleryItems);

  var modalArtworks = ''; // Create Modal Content
  ...
  galleryItems.forEach(function (item, idx) {
    ...
    console.log(itemLink); // Get a link and add

    modalArtworks += "\n    <li class=\"ma-gallery-scroller__item\" id=\"ma-gallery-scroll-item-".concat(idx, "\">\n      <figure class=\"ma-gallery-scroller__item__figure\">\n        <img class=\"ma-gallery-scroller__item__image\" src=\"").concat(imageFullPath, "\" alt=\"Artwork: ").concat(itemTitle, "\" />\n        <figcaption class=\"ma-gallery-scroller__item__title\">\n          <a href=\"").concat(itemLink, "\">").concat(itemTitle, "</a> \n          by ").concat(itemArtist, "\n        </figcaption>\n      </figure>\n    </li>");
  }); // modal markup
  ...
  galleryItems.forEach(function (galleryItem, idx) {
    ...
    itemButton.onclick = function (event) {
      ...
      dialog.show(); // Scroll to clicked item
